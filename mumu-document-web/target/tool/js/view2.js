...
DocinReaderPlayer.prototype = {
    ...
    jumpToPage: function () {
        ...
        _this.gotoBtn.bind('click', function () {
            ...
            var flashvars = {productId: readerConfig.productId, pagenum: _this.curPage},params = {wmode: 'transparent'}, attributes = {};
            swfobject.embedSWF(readerConfig.flashUrl + _this.curPage + ".swf", "swf_" + 1, '100%', '100%', "9.0.0", "", flashvars, params, attributes);
        });
    },
    prePage: function () {
        var _this = this;
        _this.preBtn.bind('click', function () {
            ...
            var flashvars = {productId: readerConfig.productId, pagenum: _this.curPage},params = {wmode: 'transparent'}, attributes = {};
            swfobject.embedSWF(readerConfig.flashUrl + _this.curPage + ".swf", "swf_" + 1, '100%', '100%', "9.0.0", "", flashvars, params, attributes);
            jQuery("#pageNumInput").val(_this.curPage);
        });
    },
    nextPage: function () {
        var _this = this;
    ...
    addFlash: function (pageno) {
        ...
        for (var p = pageno - 1; p <= pageno + 1; p++) {
            if (p != 0 && jQuery("div#swf_" + p).length > 0) {
                ...
                swfobject.embedSWF(readerConfig.flashUrl + pageno+".swf", "swf_" + 1, '100%', '100%', "9.0.0", "", flashvars, params, attributes);
            }
        }
    },
    zoomOut: function () {//缩小
